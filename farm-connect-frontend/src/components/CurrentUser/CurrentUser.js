...
const CurrentUser = (props) => {
  ...
  const redirectOnInvalidUserId = () => {
    ...
    const extractedUserId =
      !isNaN(parseInt(userPath[userPath.length - 1])) &&
      parseInt(userPath[userPath.length - 1]);
      ...
      {props.isLoading ? (
        ...
        <div className="Current-user-profile-card">
          ...
          <div className="img-div">
            {props.userPhoto ? (
              <img
                ...
                src={getUserPhoto(props.userPhoto)}
                alt="user avatar"
              />
            ) : (
              <img
          ...
          <p>
            ...
            {getFullName(
              props.userAttributes.first_name,
              props.userAttributes.last_name
            )}
          </p>
          <p>
            <label>
            ...
            {getDate(props.userAttributes.date_of_birth)}
          </p>
          <p>
            <label>
              <strong>Email:</strong>{" "}
            </label>
            {props.userAttributes.email.toLowerCase()}
          </p>
          <p id="user-joined-p">
            <label>
              <strong>Joined:</strong>{" "}
            </label>
            {getDate(props.userAttributes.created_at)}
          </p>
