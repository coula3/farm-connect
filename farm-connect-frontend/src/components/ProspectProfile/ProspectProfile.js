                ...
                :   <div className="prospect-profile-card">
                        ...
                        <div className="img-div">
                            { props.prospect.attributes.image
                                ?   <img className="prospect-img" src={prospectPhoto(props.prospect.attributes.image)} alt="user avatar" />
                                :   <img className="prospect-img" src={avatar} alt="anonymous avatar" />
                            }
                        </div>
                        ...
                        <p className="join-date-p"><label><strong>Joined:</strong> </label>{getDate(props.prospect.attributes.created_at)}</p>
