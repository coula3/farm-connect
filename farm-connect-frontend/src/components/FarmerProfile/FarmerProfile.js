                ...
                <div className="farmer_profile_card">
                    ...
                    {!isCurrentUser(props.farmer.id) ?
                        !isConnected ?
                            ...
                            <div className="connect_btn_div"><button id="unconnect_btn" className="global_btn" onClick={(e) => connectUnconnectUsers(e, props.userId, props.farmer.id)}>Unconnect</button></div>
                    :
                        null
                    }
