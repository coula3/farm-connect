...
const CreateListingForm = (props) => (
  <>
    <form onSubmit={props.handleSubmit}>
      ...
      <select
        className="create-listing-commodity-select"
        name="commodity"
        id="commodity-select"
      ...
      <span className="create-listing-errors-span">
        {messages.commodityError(props.errorMessages)}
      </span>

      <label className="create-listing-label create-listing-label-margin">
        Estimated Availability{" "}
      </label>
      <input
        className="create-listing-availability-input"
        name="availability"
        type="date"
      ...
      <br />
      <input
        className="create-listing-quantity-input"
        name="quantity"
        type="number"
        min="0"
        value={props.quantity}
        onChange={props.handleChange}
        onKeyUp={props.enableDisableMeasure}
        onMouseUp={props.enableDisableMeasure}
      />

      <select
        className="create-listing-measure-select"
        name="measure"
        disabled={props.disableMeasure}
        value={props.measure}
        onChange={props.handleChange}
      >
      ...
      <select
        className="create-listing-available-select"
        name="available"
        id="availableSelect"
      ...
      <textarea
        ...
        id="information"
        rows="8"
        maxLength={props.maxInfoCharacters}
