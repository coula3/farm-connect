    ...
    return (
        <>
            <form id="signin-form" onSubmit={props.handleSubmit}>
                <p><input id="signin-email"  ref={signinEmailInputRef} className="signin-inputs" type="text" name="email" placeholder="email" value={props.email} onChange={props.handleChange} /></p>
